...
namespace FestiveGuestAPI.Controllers
{
    ...
    public class HostPostsController : ControllerBase
    {
        ...
        public HostPostsController(IHostPostRepository hostPostRepository, INotificationService notificationService)
        {
        ...
        public async Task<IActionResult> CreatePost([FromBody] CreateHostPostRequest request)
        {
            try
            {
                ...
                // Fire-and-forget: notify matching guests
                _ = Task.Run(() => _notificationService.NotifyGuestsAboutHostPostAsync(createdPost));
        ...
        public async Task<IActionResult> UpdatePost(string id, [FromBody] UpdateHostPostRequest request)
        {
            try
            {
                ...
                // Fire-and-forget: notify matching guests about update
                _ = Task.Run(() => _notificationService.NotifyGuestsAboutHostPostAsync(updated, isUpdate: true));
